...
app.get("/api/searchData/:searchedData", (req, res) => {
  pool.getConnection((err, conn) => {
    if (err) throw err;
...
app.post("/api/historyPost/:id", (req, res) => {
  autoGeneratedData(req.body.packageType, req.body.subscripSta);
  pool.getConnection((err, conn) => {
    if (err) throw err;
    const sql =
...
app.delete("/api/deletePackage/:id", (req, res) => {
  pool.getConnection((err, conn) => {
    if (err) throw err;
...
app.get("/api/upcomingRenewalUser", (req, res) => {
  pool.getConnection((err, conn) => {
    if (err) throw err;
    const sql =
...
// app.put("/api/updateRemainingDays",(req,res)=>{
//   pool.getConnection((err,conn)=>{
//     if(err) throw err;
